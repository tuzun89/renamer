...
isbn_numbers = [
    ...
    ("978-1-882-779-X", False), # Invalid hyphen placement and digit count. This needs to be corrected via checksum. Regex does not check for this.
    ("97801360918172", False), # Invalid in general
    ("9788401459978", False), # Invalid ISBN number with correct start and correct check digits
]
